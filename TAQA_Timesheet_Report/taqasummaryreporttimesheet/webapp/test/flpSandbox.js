		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Summary Report TimeSheet",
									"targetURL": "#taqasummaryreporttimesheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqasummaryreporttimesheet-display": {
								"semanticObject": "taqasummaryreporttimesheet",
								"action": "display",
								"description": "Summary Report TimeSheet",
								"title": "Summary Report TimeSheet",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqasummaryreporttimesheet",
									"url": sap.ui.require.toUrl("taqasummaryreporttimesheet")
								}
							}
						}
					}
