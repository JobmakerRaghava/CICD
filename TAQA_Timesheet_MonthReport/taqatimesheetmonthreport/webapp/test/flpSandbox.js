		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Timesheet Month Wise Report",
									"targetURL": "#taqataqatimesheetmonthreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqataqatimesheetmonthreport-display": {
								"semanticObject": "taqataqatimesheetmonthreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqa.taqatimesheetmonthreport",
									"url": sap.ui.require.toUrl("taqa/taqatimesheetmonthreport")
								}
							}
						}
					}
