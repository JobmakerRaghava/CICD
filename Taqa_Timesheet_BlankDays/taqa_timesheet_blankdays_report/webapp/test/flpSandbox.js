		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee Blank Days Report",
									"targetURL": "#taqataqatimesheetblankdaysreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taqataqatimesheetblankdaysreport-display": {
								"semanticObject": "taqataqatimesheetblankdaysreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=taqa.taqatimesheetblankdaysreport",
									"url": sap.ui.require.toUrl("taqa/taqatimesheetblankdaysreport")
								}
							}
						}
					}
